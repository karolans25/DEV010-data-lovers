...
describe('sort', () => {
  ...
  it(`should return ${[JSON.parse(DATA_TEMP)[1], JSON.parse(DATA_TEMP)[2], JSON.parse(DATA_TEMP)[0]]} for 'country' and 1\ndonde 1 represents ascending sort`, () => {
  ...
  it(`should return ${[JSON.parse(DATA_TEMP)[0], JSON.parse(DATA_TEMP)[2], JSON.parse(DATA_TEMP)[1]]} for 'country' and '-1'\ndonde -1 represents descending sort`, () => {
  ...
  it(`should return ${[JSON.parse(DATA_TEMP)[0], JSON.parse(DATA_TEMP)[2], JSON.parse(DATA_TEMP)[1]]} for 'area' and '1'\ndonde 1 represents ascending sort`, () => {
  ...
  it(`should return ${[JSON.parse(DATA_TEMP)[1], JSON.parse(DATA_TEMP)[2], JSON.parse(DATA_TEMP)[0]]} for 'area' and '-1'\ndonde -1 represents descending sort`, () => {
  ...
  it(`should return ${[JSON.parse(DATA_TEMP)[0], JSON.parse(DATA_TEMP)[2], JSON.parse(DATA_TEMP)[1]]} for 'population' and '1'\ndonde 1 represents ascending sort`, () => {
  ...
  it(`should return ${[JSON.parse(DATA_TEMP)[1], JSON.parse(DATA_TEMP)[2], JSON.parse(DATA_TEMP)[0]]} for 'population' and '-1'\ndonde -1 represents descending sort`, () => {
